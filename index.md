...
<div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 2rem; align-items: center; margin: 2rem 0;">
  <div style="text-align: center;">
    <img src="/resmod-solutions/assets/images/logo.jpg" alt="Partner 1" style="max-width: 120px; height: auto; filter: grayscale(20%);">
    <p style="margin-top: 0.5rem;">Company Name 1</p>
  </div>
  <div style="text-align: center;">
    <img src="/resmod-solutions/assets/images/logo.jpg" alt="Partner 2" style="max-width: 120px; height: auto;">
    <p style="margin-top: 0.5rem;">Company Name 2</p>
  </div>
  <div style="text-align: center;">
    <img src="/resmod-solutions/assets/images/logo.jpg" alt="Partner 3" style="max-width: 120px; height: auto;">
